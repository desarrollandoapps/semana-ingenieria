...
class EventoSeeder extends Seeder
{
    ...
    {
        //
        Evento::create( [   'dia' => 'Martes',
                            'fecha' => '17/05/2022', 
                            'horario' => '04:00 PM - 05:00 PM', 
                            'tema' => 'Redes Neuronales Convolucionales en Imagenología Médica', 
                            'conferencista' => Conferencista::where('name', 'Hector Gabriel Acosta Mesa')->first(), 
       ...
       Evento::create( [    'dia' => 'Martes',
                            ...
                            'conferencista' => Conferencista::where('name', 'Gina Paola Maestre')->first(), 
                            'lugar' => 'Sala de Conferencias',
                            'enlaceVirtual' => 'meet.google.com/aig-neks-bfq',  
                            'colaborador' => '',  
                            'tipoEvento' => 'CONFERENCIA',  
